...
# 1. INPUT PARAMETERS
_controller_url="https://closebrothers.saas.appdynamics.com:443/controller"   # hostname + /controller
_user_credentials="aleksandra.jovovic@closebrothers:Welcome234!" # ${username}:${password}

_application_name="Premium_Finance–Loan_Management–prod"
_app_id=23600
_proxy_details=
...
function func_get_application_id() {
    ...
    #echo "curl -v --user ${_user_credentials} ${_controller_url}/rest/applications?output=JSON ${_proxy_details}"
...
#init HR templates
serverVizHealthRuleFile="./health_rules/${_application_name}/ServerVisibility/*.json"
applicationHealthRule="./health_rules/${_application_name}/Application/*.json"
