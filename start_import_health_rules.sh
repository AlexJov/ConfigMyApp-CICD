...
# 1. INPUT PARAMETERS
_controller_url="https://csnappdp.csnnet.int:8181/controller"   # hostname + /controller
_user_credentials="csn9080@customer1:xxxx" # ${username}:${password}

_application_name=Producktion #Producktion
_proxy_details=
...
#curl -v --user "csn9080@customer1:xxxx" https://csnappdp.csnnet.int:8181/controller/rest/applications?output=JSON
...
#init HR templates
#serverVizHealthRuleFile="./health_rules/*.json"
applicationHealthRule="*.json"
